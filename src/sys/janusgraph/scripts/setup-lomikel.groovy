...
class LomikelServer {
  ...
  def static graph = JanusGraphFactory.build().set("storage.backend", "hbase").set("storage.hostname", "157.136.250.219").set("storage.port", "2183").set("storage.hbase.table", "janusgraph").open();

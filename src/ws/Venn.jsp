...
<script type="text/javascript">
  ...
  m1  = callGremlinValues(gr + ".E('" + id + "').outV().values('sourceType', 'alertType').toSet().toArray().join('')")[0];
  m2  = callGremlinValues(gr + ".E('" + id + "').inV().values('sourceType', 'alertType').toSet().toArray().join('')")[0];

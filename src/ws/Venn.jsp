...
<script type="text/javascript">
  ...
  m1  = callGremlinValues(gr + ".E('" + id + "').outV().values('alertType', 'sourceType').toSet().toArray().join('')")[0];
  m2  = callGremlinValues(gr + ".E('" + id + "').inV().values('alertType', 'sourceType').toSet().toArray().join('')")[0];

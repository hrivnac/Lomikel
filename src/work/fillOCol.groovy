...
classifiers = new Classifier[]{Classifier.instance('FINK'),
                               ...
                               Classifier.instance('FEATURES=Clusters/ZTF/2024/13-60'),
                               Classifier.instance('FEATURES=Clusters/ZTF/2025/13-50'),
                               Classifier.instance('TAG')}
formula = "cdsxmatch != 'Unknown' && roid != 3 && ndethist >= 3";
gr.processOCol(classifiers, formula, 'vdhbase1.lal.in2p3.fr:2183:ztf:schema_4.0_6.1.1', 2000, 150, null);

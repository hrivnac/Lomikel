...
source.setLimit(Integer.MAX_VALUE);
client = new FinkHBaseClient("hbase-1.lal.in2p3.fr", 2183);
client.connect("Curves.upper", null);
client.assembleCurves(oids,
                      objectId,
                      "i:jd,i:diffmaglim",
                      "schema_0_0_1");
                      
source = new HBaseClient("hbase-1.lal.in2p3.fr", 2183);
source.connect("ztf.uppervalid");
source.setLimit(Integer.MAX_VALUE);
client = new FinkHBaseClient("hbase-1.lal.in2p3.fr", 2183);
client.connect("Curves.uppervalid", null);
client.assembleCurves(source,
                      oids,
                      "i:jd,i:diffmaglim,i:magpsf,i:sigmapsf",
                      "schema_0_0_1");

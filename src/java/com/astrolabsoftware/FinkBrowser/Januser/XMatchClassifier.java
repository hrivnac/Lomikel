...
public class XMatchClassifier extends ZTFClassifier {
  ...
  public void classify(FinkGremlinRecipies recipies,
    ...
    for (int i = 0; i < ja.length(); i++) {
      ...
      if (!cl.equals("Unknown") && !FinkZTFClassifier.finkClasses().contains(cl)) {
  ...
  /** Logging . */
  private static Logger log = LogManager.getLogger(XMatchClassifier.class);

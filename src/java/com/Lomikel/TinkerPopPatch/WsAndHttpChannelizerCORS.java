 ...
 */
public class WsAndHttpChannelizerCORS extends AbstractChannelizer {

    private WsAndHttpChannelizerHandlerCORS handler;

    @Override
    public void init(final ServerGremlinExecutor serverGremlinExecutor) {
        super.init(serverGremlinExecutor);
        handler = new WsAndHttpChannelizerHandlerCORS();
        handler.init(serverGremlinExecutor, new HttpGremlinEndpointHandlerCORS(serializers, gremlinExecutor, graphManager, settings));
    }

// https://api.ztf.fink-portal.org/api
...
FINK_OBJECTS_WS = "https://api.ztf.fink-portal.org/api/v1/objects";
FINK_LATESTS_WS = "https://api.ztf.fink-portal.org/api/v1/latests";
FINK_ANOMALY_WS = "https://api.ztf.fink-portal.org/api/v1/anomaly";

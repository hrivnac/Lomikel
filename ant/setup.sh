...
echo "commands: gremlin_console_Local, gremlin_console_IJCLab, gremlin_console_CC, gremlin_Local, gremlin_IJCLab, gremlin_CC, lomikel, lomikel_pure, lomikel_hbase, lomikel_hadoop, lomikel_janus, lomikel_dl4j"
